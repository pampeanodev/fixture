export const es = {
  ...
  autoSync: {
    ...
    autoSyncedTooltip: "Actualizado automáticamente con el resultado oficial el {datetime}",
    breakerTrippedTitle: "Auto-sync pausado",
    breakerTrippedMessage: "Los resultados oficiales no coinciden con el fixture. Podés re-activarlo en Configuración.",
  ...
  ranking: {
    ...
    rule: {
      ...
      exactExampleDraw: "Empate: predecís 2-2 y sale 2-2",
      winnerPoints: "1 pt",
      winnerSymbol: "+1",
      winnerLabel: "Ganador correcto",
      winnerExample: "Predecís 2-0 y sale 3-1",
      winnerExampleDraw: "Empate: predecís 2-2 y sale 1-1",
      penBonusPoints: "+1 pt",
      penBonusSymbol: "⚽",
      penBonusLabel: "Bonus de penales",
      penBonusExample: "Knockout terminó empatado y acertaste quién pasa por penales",
      wrongPoints: "0 pts",
      wrongSymbol: "0",
      wrongLabel: "Resultado errado",
      wrongExample: "Predecís victoria local y gana el visitante",
      wrongExampleDraw: "Empate: predecís 2-2 y gana uno 2-1",
    },
    rulesSectionTiebreak: "Desempate",
    tiebreakIntro: "Si dos jugadores tienen los mismos puntos, se desempata por:",
    tiebreak1: "Mayor cantidad de resultados exactos (+3)",
    tiebreak2: "Mayor cantidad de ganadores correctos (+1)",
  ...
  tour: {
    ...
    overview: {
      ...
      welcomeBody: "Predecís los 104 partidos del Mundial y ganás puntos cuando acertás. <1>3 pts</1> resultado exacto · <2>1 pt</2> solo ganador · <4>+1</4> bonus si acertás los penales del knockout · <3>0</3> errado.",
